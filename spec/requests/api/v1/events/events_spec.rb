...
describe 'POST /v1/events' do
  it 'saves the address, lat, lon, name, and started at date' do 
    date = Time.zone.now
    device_token = '123abc456xyz'
    owner = create(:user, device_token: device_token)
...
describe 'PATCH /v1/events/:id' do 
  it 'updates the event attributes' do
    owner = create(:user, device_token: '12345')
    event = create(:event, name: 'Old name', owner: owner )
    new_name = 'New name'
